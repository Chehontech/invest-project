                    ...
                    <div class="card-body form-block">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-10">
                                    ...
                                    <input type="text" name="username" placeholder="{{__('Username')}}:" class="form-control" value="{{$client->username}}">
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-10">
                                    <input type="email" name="email" placeholder="{{__('Email')}}:" class="form-control" readonly value="{{$client->email}}">
                                </div>
                            </div>
                            <div class="form-group row">
                                <!--<label class="col-form-label col-lg-2">{{__('Mobile')}}:</label> -->
                                <div class="col-lg-10">
                                    <input type="text" name="mobile" class="form-control" placeholder="{{__('Mobile')}}:" value="{{$client->phone}}">
                                </div>
                            </div>                                              
                            <div class="form-group row">
                                <!--<label class="col-form-label col-lg-2">{{__('Address')}}:</label> -->
                                <div class="col-lg-10">
                                    <input type="text" name="address" class="form-control" placeholder="{{__('Address')}}:"  value="{{$client->address}}">
                                </div>
                            </div>
                            <div class="form-group row">
                               <!-- <label class="col-form-label col-lg-2">{{__('Balance:')}}</label> -->
                                <div class="col-lg-10">
                                    <div class="input-group">
                                        ...
                                        <input type="number" name="balance"step="any" placeholder="{{__('Balance:')}}" max-length="10" value="{{convertFloat($client->balance)}}" class="form-control">
                                    </div>
                                </div>
                            </div> 
                            <div class="form-group row">
