          ...
          <ul class="navbar-nav mb-md-3"> 
            ...
            <li class="nav-item">
              ...
              <div class="collapse @if(route('admin.py.pending')==url()->current() || route('admin.py.completed')==url()->current() || route('admin.py.plans')==url()->current()|| route('admin.py.coupon')==url()->current()) show @endif" id="tcard">
                <ul class="nav nav-sm flex-column">
					 	      <li class="nav-item @if(route('admin.py.pending')==url()->current()) active @endif"><a href="{{route('admin.py.pending')}}" class="nav-link">Running</a></li>
					 	      <li class="nav-item @if(route('admin.py.completed')==url()->current()) active @endif"><a href="{{route('admin.py.completed')}}" class="nav-link">Ended</a></li>
            ...
            <li class="nav-item">
              ...
              <div class="collapse @if(route('admin.sand.py.pending')==url()->current() || route('admin.sand.py.completed')==url()->current() || route('admin.sand.py.plans')==url()->current()|| route('admin.sand.py.category')==url()->current()) show @endif" id="fcard">
                <ul class="nav nav-sm flex-column">
                  <li class="nav-item @if(route('admin.sand.py.pending')==url()->current()) active @endif"><a href="{{route('admin.sand.py.pending')}}" class="nav-link">{{__('Running')}}</a></li>
                  <li class="nav-item @if(route('admin.sand.py.completed')==url()->current()) active @endif"><a href="{{route('admin.sand.py.completed')}}" class="nav-link">{{__('Ended')}}</a></li>
                  <li class="nav-item @if(route('admin.sand.py.plans')==url()->current()) active @endif"><a href="{{route('admin.sand.py.plans')}}" class="nav-link">{{__('Plans')}}</a></li>                    
                  <li class="nav-item @if(route('admin.sand.py.category')==url()->current()) active @endif"><a href="{{route('admin.sand.py.category')}}" class="nav-link">{{__('Category')}}</a></li>                    
                </ul>
              </div>
            </li>		
            <li class="nav-item">
