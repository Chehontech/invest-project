...
<html class="no-js" lang="en">
    ...
    <body class="content-front">
                        ...
                        <div class="navbar-nav-wrap-content text-center">
                            <div class="d-none d-lg-block login-btn">
                                <?php if(Auth::guard('user')->check()): ?>
                                    <a href="<?php echo e(route('user.dashboard')); ?>" class="btn btn-sm btn-light"><?php echo e(__('Dashboard')); ?></a>
                                <?php else: ?>
                                    <a href="<?php echo e(route('login')); ?>" class="btn btn-sm btn-light "><?php echo e(__('Sign In')); ?></a>
                                <?php endif; ?>
                            </div>
                        </div>
        ...
        <script src="<?php echo e(url('/')); ?>/asset/dashboard/js/argon.js"></script>
        <!-- JS Front -->
...
</html><?php /**PATH /sites/invest.adder.com.ua/core/resources/views/layout.blade.php ENDPATH**/ ?>