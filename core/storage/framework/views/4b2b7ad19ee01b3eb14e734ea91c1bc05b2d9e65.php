      ...
      <div class="navbar-inner">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
          ...
          <ul class="navbar-nav mb-md-3"> 
            ...
            <li class="nav-item">
              ...
              <div class="collapse <?php if(route('admin.py.pending')==url()->current() || route('admin.py.completed')==url()->current() || route('admin.py.plans')==url()->current()|| route('admin.py.coupon')==url()->current()): ?> show <?php endif; ?>" id="tcard">
                <ul class="nav nav-sm flex-column">
					 	      <li class="nav-item <?php if(route('admin.py.pending')==url()->current()): ?> active <?php endif; ?>"><a href="<?php echo e(route('admin.py.pending')); ?>" class="nav-link">Running</a></li>
					 	      <li class="nav-item <?php if(route('admin.py.completed')==url()->current()): ?> active <?php endif; ?>"><a href="<?php echo e(route('admin.py.completed')); ?>" class="nav-link">Ended</a></li>
            ...
            <li class="nav-item">
              ...
              <div class="collapse <?php if(route('admin.sand.py.pending')==url()->current() || route('admin.sand.py.completed')==url()->current() || route('admin.sand.py.plans')==url()->current()|| route('admin.sand.py.category')==url()->current()): ?> show <?php endif; ?>" id="fcard">
                <ul class="nav nav-sm flex-column">
                  <li class="nav-item <?php if(route('admin.sand.py.pending')==url()->current()): ?> active <?php endif; ?>"><a href="<?php echo e(route('admin.sand.py.pending')); ?>" class="nav-link"><?php echo e(__('Running')); ?></a></li>
                  <li class="nav-item <?php if(route('admin.sand.py.completed')==url()->current()): ?> active <?php endif; ?>"><a href="<?php echo e(route('admin.sand.py.completed')); ?>" class="nav-link"><?php echo e(__('Ended')); ?></a></li>
                  <li class="nav-item <?php if(route('admin.sand.py.plans')==url()->current()): ?> active <?php endif; ?>"><a href="<?php echo e(route('admin.sand.py.plans')); ?>" class="nav-link"><?php echo e(__('Plans')); ?></a></li>                    
                  <li class="nav-item <?php if(route('admin.sand.py.category')==url()->current()): ?> active <?php endif; ?>"><a href="<?php echo e(route('admin.sand.py.category')); ?>" class="nav-link"><?php echo e(__('Category')); ?></a></li>                    
                </ul>
              </div>
            </li>		
            <li class="nav-item">
          ...
          <ul class="navbar-nav mb-md-3"> 
            ...
            <li class="nav-item">
              <a class="nav-link  <?php if(route('homepage')==url()->current() || route('admin.team')==url()->current() || route('admin.service')==url()->current() || route('admin.logo')==url()->current() || route('admin.review')==url()->current() || route('admin.page')==url()->current() || route('admin.faq')==url()->current() || route('admin.terms')==url()->current() || route('privacy-policy')==url()->current() || route('about-us')==url()->current() || route('social-links')==url()->current()): ?> active <?php endif; ?> text-dark" href="#xx" data-toggle="collapse" role="button" aria-expanded="false" aria-controls="navbar-examples">
                <i class="fad fa-desktop"></i>
                <span class="nav-link-text"><?php echo e(__('Website design')); ?></span>
              </a>
              <div class="collapse <?php if(route('homepage')==url()->current() || route('admin.team')==url()->current() || route('admin.service')==url()->current() || route('admin.logo')==url()->current() || route('admin.review')==url()->current() || route('admin.page')==url()->current() || route('admin.faq')==url()->current() || route('admin.terms')==url()->current() || route('privacy-policy')==url()->current() || route('about-us')==url()->current() || route('social-links')==url()->current()): ?> show <?php endif; ?>  text-dark" id="xx">
                <ul class="nav nav-sm flex-column">
            ...
            <li class="nav-item">
              <a class="nav-link <?php if(route('admin.currency')==url()->current()): ?> active <?php endif; ?> text-dark" href="<?php echo e(route('admin.currency')); ?>">
                <i class="fad fa-money-bill-wave-alt"></i>
    ...
    <nav class="navbar navbar-top navbar-expand navbar-dark border-bottom">
      <div class="container-fluid">
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <ul class="navbar-nav align-items-center ml-auto ml-md-0 user-box">
            <li class="nav-item">
...
<?php endif; ?>
<?php /**PATH /sites/invest.adder.com.ua/core/resources/views/master.blade.php ENDPATH**/ ?>