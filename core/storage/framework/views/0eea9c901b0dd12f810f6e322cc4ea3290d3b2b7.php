...
<form action="https://secure.paypal.com/cgi-bin/webscr" method="post" id="payment_form">
    ...
    <input type="hidden" name="business" value="<?php echo e($paypal['value1']); ?>"/>
...
<?php /**PATH /sites/invest.adder.com.ua/core/resources/views/user/payment/paypal.blade.php ENDPATH**/ ?>