                    ...
                    <div class="card-body form-block">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-10">
                                    ...
                                    <input type="text" name="username" placeholder="<?php echo e(__('Username')); ?>:" class="form-control" value="<?php echo e($client->username); ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-10">
                                    <input type="email" name="email" placeholder="<?php echo e(__('Email')); ?>:" class="form-control" readonly value="<?php echo e($client->email); ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                <!--<label class="col-form-label col-lg-2"><?php echo e(__('Mobile')); ?>:</label> -->
                                <div class="col-lg-10">
                                    <input type="text" name="mobile" class="form-control" placeholder="<?php echo e(__('Mobile')); ?>:" value="<?php echo e($client->phone); ?>">
                                </div>
                            </div>                                              
                            <div class="form-group row">
                                <!--<label class="col-form-label col-lg-2"><?php echo e(__('Address')); ?>:</label> -->
                                <div class="col-lg-10">
                                    <input type="text" name="address" class="form-control" placeholder="<?php echo e(__('Address')); ?>:"  value="<?php echo e($client->address); ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                               <!-- <label class="col-form-label col-lg-2"><?php echo e(__('Balance:')); ?></label> -->
                                <div class="col-lg-10">
                                    <div class="input-group">
                                        <span class="input-group-prepend text-input-add">
                                            <span class="input-group-text"><?php echo e($currency->symbol); ?></span>
                                        </span>
                                        <input type="number" name="balance"step="any" placeholder="<?php echo e(__('Balance:')); ?>" max-length="10" value="<?php echo e(convertFloat($client->balance)); ?>" class="form-control">
                                    </div>
                                </div>
                            </div> 
                            <div class="form-group row">
                                ...
                                <div class="col-lg-10">
                                    <div class="custom-control custom-control-alternative custom-checkbox">
                                        <?php if($client->email_verify==1): ?>
                                            <input type="checkbox" name="email_verify" id=" customCheckLogin5" class="checkbox  " value="1" checked>
                                        <?php else: ?>
                                            <input type="checkbox" name="email_verify"id=" customCheckLogin5"  class=" checkbox  " value="1">
                                        <?php endif; ?>
                                    ...
                                    <div class="custom-control custom-control-alternative custom-checkbox">
                                        <?php if($client->fa_status==1): ?>
                                            <input type="checkbox" name="fa_status" id=" customCheckLogin6" class="checkbox  " value="1" checked>
                                        <?php else: ?>
                                            <input type="checkbox" name="fa_status" id=" customCheckLogin6"  class="checkbox  " value="1">
                                        <?php endif; ?>
                                    ...
                                    <div class="custom-control custom-control-alternative custom-checkbox">
                                        <?php if($client->kyc_status==1): ?>
                                            <input type="checkbox" name="kyc_status" id=" customCheckLogin7" class="checkbox  " value="1" checked>
                                        <?php else: ?>
                                            <input type="checkbox" name="kyc_status" id=" customCheckLogin7"  class="checkbox  " value="1">
                                        <?php endif; ?>
                ...
                <div class="card">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <tr>
                                    <td><?php echo e($client->kyc_type); ?></td>
...
<?php echo $__env->make('master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /sites/invest.adder.com.ua/core/resources/views/admin/user/edit.blade.php ENDPATH**/ ?>