            ...
            <div class="card card-bg-light h-100 shadow-none overflow-hidden transition-3d-hover">
              <div class="row align-items-center mt-3">
                <div class="col-8 col-md-8">
                  ...
                  <span class="font-size-1 text-primary text-sm link"><a href="<?php echo e(route('user.sandplans')); ?>">Buy units </a><i class="fad fa-angle-right fa-sm ml-1"></i></span>
                  </div>
                </div>
            ...
            <div class="card card-bg-light h-100 shadow-none overflow-hidden transition-3d-hover">
              <div class="row align-items-center mt-3">
                <div class="col-8 col-md-8">
                  ...
                  <span class="font-size-1 text-primary text-sm link"><a href="<?php echo e(route('user.plans')); ?>">Investment Plans </a><i class="fad fa-angle-right fa-sm ml-1"></i></span>
                  </div>
                </div>
                <div class="col-4 col-md-4 px-0">
            ...
            <div class="card card-bg-light h-100 shadow-none overflow-hidden transition-3d-hover">
              <div class="row align-items-center mt-3">
                <div class="col-8 col-md-8">
                  ...
                  <span class="font-size-1 text-primary text-sm link"><a href="<?php echo e(route('user.savings')); ?>">Apply now </a><i class="fad fa-angle-right fa-sm ml-1"></i></span>
                  </div>
                </div>
                <div class="col-4 col-md-4 px-0">
            ...
            <div class="card card-bg-light h-100 shadow-none overflow-hidden transition-3d-hover">
              <div class="row align-items-center mt-3">
                <div class="col-8 col-md-8">
                  ...
                  <span class="font-size-1 text-primary text-sm link"><a href="<?php echo e(route('user.referral')); ?>">Refer family & friends </a><i class="fad fa-angle-right fa-sm ml-1"></i></span>
                  </div>
                </div>
                <div class="col-4 col-md-4 px-0">
...
<?php echo $__env->make('userlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /sites/invest.adder.com.ua/core/resources/views/user/index.blade.php ENDPATH**/ ?>