  ...
  <div class="container">
    <div class="row no-gutters">
      <div class="col-md-8 col-lg-7 col-xl-6 offset-md-2 offset-lg-2 offset-xl-3 space-top-3 space-lg-0">
        <!-- Form -->
        <form role="form" action="<?php echo e(route('user.upload-kyc')); ?>" method="post">
          <?php echo csrf_field(); ?>
          ...
          <div class="form-group mb-3">
                    ...
                    <div class="text-center">
                        <div class="form-group">
                            <div class="custom-file">
                                ...
                                <label class="custom-file-label" for="customFileLang" style="border-color: <?php echo e($set->s_c); ?>;"><?php echo e(__('Select document')); ?></label>
                            </div> 
                        </div> 
                ...
                <div class="text-center">
                    <?php if($user->kyc_link==null && $user->kyc_status==0): ?>
                        <button type="submit" class="btn btn-neutral btn-block my-4 text-uppercase"><?php echo e(__('Upload')); ?></button>
                    <?php endif; ?>
...
<?php echo $__env->make('loginlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/kingsmen/new/core/resources/views/user/security/no-kyc.blade.php ENDPATH**/ ?>