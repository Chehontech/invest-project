                      ...
                      <?php if($val->status!=2): ?>             
                        <div class="col-12">
                          <?php if($val->recurring==1): ?>
                            <?php if($val->c_r==1): ?>
                            <a href="<?php echo e(url('/')); ?>/user/cancel-recurring/<?php echo e($val->trx); ?>" class="btn btn-sm btn-danger"><i class="fad fa-ban"></i> <?php echo e(__('Cancel Recurring')); ?></a>
                            <?php elseif($val->c_r==0): ?>
                            <a href="<?php echo e(url('/')); ?>/user/start-recurring/<?php echo e($val->trx); ?>" class="btn btn-sm btn-success"><i class="fad fa-check"></i> <?php echo e(__('Start Recurring')); ?></a>
                            <?php endif; ?>
                          <?php endif; ?>
...
<?php echo $__env->make('userlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /sites/invest.adder.com.ua/core/resources/views/user/trading/trades.blade.php ENDPATH**/ ?>