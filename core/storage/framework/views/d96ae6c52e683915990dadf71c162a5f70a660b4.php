      ...
      <div class="col-lg-4">
        ...
        <div class="card">
          <div class="card-body">
            ...
            <span class="form-text text-sm"><?php echo e($refLink); ?></span>
            <button type="button" class="btn-icon-clipboard" data-clipboard-text="<?php echo e($refLink); ?>" title="Copy"><?php echo e(__('Copy')); ?></button>
          </div>
        </div>
        <?php endif; ?>
          <div class="card">
...
<?php echo $__env->make('userlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /sites/invest.adder.com.ua/core/resources/views/user/profile/referral.blade.php ENDPATH**/ ?>