...
<div class="container-fluid mt--6">
    <div class="content-wrapper">
        <div class="row">
            <div class="col-lg-12">
                <div class="">
                <div class="card-body">
                <a data-toggle="modal" data-target="#create" href="" class="btn btn-sm btn-neutral add-elem"><i class="fa fa-plus"></i> <?php echo e(__('Create Type')); ?></a>
                </div>
                </div>
            </div>
        </div>
    ...
    <div id="create" class="modal fade" tabindex="-1">
        <div class="modal-dialog modal-lg">
            <div class="modal-content form-block form-modal form-block form-modal">
                ...
                <?php echo csrf_field(); ?>
                    <div class="modal-body">
                        <div class="form-group row">
                            ...
                            <div class="col-lg-10">
                                <input type="text" name="name" placeholder="<?php echo e(__('Name')); ?>:" class="form-control" required>
                            </div>
                        </div>               
                    </div>
...
<?php echo $__env->make('master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /sites/invest.adder.com.ua/core/resources/views/admin/withdrawal/methods.blade.php ENDPATH**/ ?>